...
class EventTimeWarp : public IObject {
...
public:
        ...
        static const ssi_char_t *GetCreateName () { return "EventTimeWarp"; };
        static IObject *Create (const ssi_char_t *file) { return new EventTimeWarp (file); };
        ~EventTimeWarp ();
...
protected:
        ...
        EventTimeWarp (const ssi_char_t *file = 0);
        EventTimeWarp::Options _options;
	ssi_char_t *_file;
