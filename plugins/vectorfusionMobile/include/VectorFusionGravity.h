...
#ifndef SSI_VECTORFUSIONGRAVITY_H
#define SSI_VECTORFUSIONGRAVITY_H
...
class VectorFusionGravity : public IObject {
...
public: 	
	...
	static const ssi_char_t *GetCreateName () { return "VectorFusionGravity"; };
	static IObject *Create (const ssi_char_t *file) { return new VectorFusionGravity (file); };
	~VectorFusionGravity ();
...
protected:
	...
	VectorFusionGravity (const ssi_char_t *file = 0);
	Options _options;
	ssi_char_t *_file;
