...
#include "../include/VectorFusionGravity.h"
...
ssi_char_t *VectorFusionGravity::ssi_log_name = "vecfus_g__";

VectorFusionGravity::VectorFusionGravity (const ssi_char_t *file)
	: _file (0),
	_dim (0),
	_update_ms (0),
	_update_counter(0),
...
bool VectorFusionGravity::setEventListener (IEventListener *listener) {
...
void VectorFusionGravity::listen_enter (){
...
bool VectorFusionGravity::update (IEvents &events, ssi_size_t n_new_events, ssi_size_t time_ms) {
...
void VectorFusionGravity::listen_flush (){
...
bool VectorFusionGravity::transformEventToVector(ssi_event_t *Event){
...
bool VectorFusionGravity::combineVectors(ssi_real_t fusion_speed, ssi_real_t delta_t, ssi_real_t threshold){
...
EVector* VectorFusionGravity::getFusionVector(){
	return _fusion_vector;
}

ssi_real_t VectorFusionGravity::getThreshold(){
	return _threshold;
}

void VectorFusionGravity::print(){
...
void VectorFusionGravity::initAxisCaption(ssi_size_t dim){
...
bool VectorFusionGravity::notify(INotify::COMMAND::List command, const ssi_char_t *message) {
