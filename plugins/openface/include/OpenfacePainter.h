...
#ifndef SSI_OPENFACE_OPENFACEPAINTER_H
#define SSI_OPENFACE_OPENFACEPAINTER_H
...
namespace ssi {
	...
	class OpenfacePainter : public IFilter {
	...
	public:
		...
		static const ssi_char_t *GetCreateName() { return "OpenfacePainter"; };
		static IObject *Create(const ssi_char_t *file) { return new OpenfacePainter(file); };
		~OpenfacePainter();
	...
	protected:
		...
		OpenfacePainter(const ssi_char_t *file = 0);
		ssi_char_t *_file;
		Options _options;
