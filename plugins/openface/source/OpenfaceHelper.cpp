...
namespace ssi
{
	...
	*/
    ...
    vector<pair<cv::Point, cv::Point>> OpenfaceHelper::calculate_box(cv::Vec6d pose, float fx, float fy, float cx, float cy)
    {
        return LandmarkDetector::CalculateBox(pose, fx, fy,cx, cy);
    }
